...
from django.contrib.auth.decorators import login_required  # function base e use hoi
from django.contrib.auth.mixins import LoginRequiredMixin
from App_Blog.forms import CommentForm
import uuid  # unique id generate korar jonno
...
class CreateBlog(LoginRequiredMixin, CreateView):
    ...
    # class er vetor kono form submit er por kaj kore amn ekta built in object ache
